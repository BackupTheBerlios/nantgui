...
Source: NAnt-Gui.Gui\BlankProject.build; DestDir: {app}\Data; Flags: ignoreversion
...
Source: NAnt-Gui.Gui\Properties\*.resx; DestDir: {app}\src\NAnt-Gui.Gui\Properties; Flags: ignoreversion; Components: src
