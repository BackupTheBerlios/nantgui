...
//	#endregion
	...
	public class PropertyShelf : ICustomTypeDescriptor	
	{
		...
		{
//			private PropertyShelf _shelf;
			private BuildProperty _item;

			public BuildPropertyDescriptor(BuildProperty item, PropertyShelf shelf, string name, Attribute[] attrs) :
				base(name, attrs)
			{
//				_shelf = shelf;
				_item = item;
			...
			public override bool CanResetValue(object component)
			{
				return _item.DefaultValue == null ?
					false :
                    //!GetValue(component).Equals(_item.DefaultValue);
...
//
//			if (property != null)
//				return new PropertyDescriptor(property, this, property.Name, null);
//			else
				return null;
		}
...
//
				...
				// it to the list.
				BuildPropertyDescriptor pd = new BuildPropertyDescriptor(property,
