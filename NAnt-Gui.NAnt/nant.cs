...
namespace NAntGui.NAnt.NAnt
{
	...
	public class project
	{
		...
		[XmlElement("nant", typeof (NAntCoreTasksNAntTask))]
		[XmlElement("filterchain", typeof (NAntCoreFiltersFilterChain))]
		[XmlElement("testtask", typeof (TestsNAntCoreUtilXmlLoggerTestTestTask))]
		[XmlElement("attrib", typeof (NAntCoreTasksAttribTask))]
		[XmlElement("setenv", typeof (NAntCoreTasksSetEnvTask))]
		[XmlElement("cvs-rtag", typeof (NAntSourceControlTasksRTagTask))]
		[XmlElement("assemblyfileset", typeof (NAntDotNetTypesAssemblyFileSet))]
		[XmlElement("uptodate", typeof (NAntCoreTasksUpToDateTask))]
		[XmlElement("vbc", typeof (NAntDotNetTasksVbcTask))]
		[XmlElement("al", typeof (NAntDotNetTasksAssemblyLinkerTask))]
		[XmlElement("fileset", typeof (NAntCoreTypesFileSet))]
		[XmlElement("rc", typeof (NAntVisualCppTasksRcTask))]
		[XmlElement("resgen", typeof (NAntDotNetTasksResGenTask))]
		[XmlElement("vjc", typeof (NAntDotNetTasksVjcTask))]
		[XmlElement("echo", typeof (NAntCoreTasksEchoTask))]
		[XmlElement("move", typeof (NAntCoreTasksMoveTask))]
		[XmlElement("mkdir", typeof (NAntCoreTasksMkDirTask))]
		[XmlElement("delay-sign", typeof (NAntDotNetTasksDelaySignTask))]
		[XmlElement("if", typeof (NAntCoreTasksIfTask))]
		[XmlElement("loadtasks", typeof (NAntCoreTasksLoadTasksTask))]
		[XmlElement("cvs-export", typeof (NAntSourceControlTasksExportTask))]
		[XmlElement("unzip", typeof (NAntCompressionTasksUnZipTask))]
		[XmlElement("jsc", typeof (NAntDotNetTasksJscTask))]
		[XmlElement("link", typeof (NAntVisualCppTasksLinkTask))]
		[XmlElement("midl", typeof (NAntVisualCppTasksMidlTask))]
		[XmlElement("cvs-tag", typeof (NAntSourceControlTasksTagTask))]
		[XmlElement("csc", typeof (NAntDotNetTasksCscTask))]
		[XmlElement("dirset", typeof (NAntCoreTypesDirSet))]
		[XmlElement("readregistry", typeof (NAntWin32TasksReadRegistryTask))]
		[XmlElement("credential", typeof (NAntCoreTypesCredential))]
		[XmlElement("touch", typeof (NAntCoreTasksTouchTask))]
		[XmlElement("cvs-changelog", typeof (NAntSourceControlTasksChangeLogTask))]
		[XmlElement("style", typeof (NAntCoreTasksStyleTask))]
		[XmlElement("cl", typeof (NAntVisualCppTasksClTask))]
		[XmlElement("cvs-pass", typeof (NAntSourceControlTasksCvsPass))]
		[XmlElement("cvsfileset", typeof (NAntSourceControlTypesCvsFileSet))]
		[XmlElement("proxy", typeof (NAntCoreTypesProxy))]
		[XmlElement("cvs-update", typeof (NAntSourceControlTasksUpdateTask))]
		[XmlElement("gunzip", typeof (NAntCompressionTasksGUnzip))]
		[XmlElement("test", typeof (TestsNAntCoreTestTask))]
		[XmlElement("foreach", typeof (NAntCoreTasksLoopTask))]
		[XmlElement("nunit2", typeof (NAntNUnit2TasksNUnit2Task))]
		[XmlElement("categoryset", typeof (NAntNUnit2TypesCategorySet))]
		[XmlElement("copy", typeof (NAntCoreTasksCopyTask))]
		[XmlElement("solution", typeof (NAntVSNetTasksSolutionTask))]
		[XmlElement("get", typeof (NAntCoreTasksGetTask))]
		[XmlElement("resourcefileset", typeof (NAntDotNetTypesResourceFileSet))]
		[XmlElement("cvs", typeof (NAntSourceControlTasksCvsTask))]
		[XmlElement("ildasm", typeof (NAntMSNetTasksIldasmTask))]
		[XmlElement("asminfo", typeof (NAntDotNetTasksAssemblyInfoTask))]
		[XmlElement("path", typeof (NAntCoreTypesPathSet))]
		[XmlElement("property", typeof (NAntCoreTasksPropertyTask))]
		[XmlElement("mc", typeof (NAntVisualCppTasksMcTask))]
		[XmlElement("elementTest1", typeof (TestsNAntCoreElementTest1Task))]
		[XmlElement("call", typeof (NAntCoreTasksCallTask))]
		[XmlElement("aximp", typeof (NAntWin32TasksAxImpTask))]
		[XmlElement("regex", typeof (NAntCoreTasksRegexTask))]
		[XmlElement("description", typeof (NAntCoreTasksDescriptionTask))]
		[XmlElement("tarfileset", typeof (NAntCompressionTypesTarFileSet))]
		[XmlElement("fail", typeof (NAntCoreTasksFailTask))]
		[XmlElement("nunit", typeof (NAntNUnit1TasksNUnitTask))]
		[XmlElement("available", typeof (NAntCoreTasksAvailableTask))]
		[XmlElement("ndoc", typeof (NAntDotNetTasksNDocTask))]
		[XmlElement("tlbimp", typeof (NAntWin32TasksTlbImpTask))]
		[XmlElement("zipfileset", typeof (NAntCompressionTypesZipFileSet))]
		[XmlElement("license", typeof (NAntDotNetTasksLicenseTask))]
		[XmlElement("tlbexp", typeof (NAntWin32TasksTlbExpTask))]
		[XmlElement("tar", typeof (NAntCompressionTasksTarTask))]
		[XmlElement("zip", typeof (NAntCompressionTasksZipTask))]
		[XmlElement("target", typeof (Target))]
		[XmlElement("loadfile", typeof (NAntCoreTasksLoadFileTask))]
		[XmlElement("cvs-checkout", typeof (NAntSourceControlTasksCheckoutTask))]
		[XmlElement("xmlpoke", typeof (NAntCoreTasksXmlPokeTask))]
		[XmlElement("servicecontroller", typeof (NAntMSNetTasksServiceControllerTask))]
		[XmlElement("script", typeof (NAntDotNetTasksScriptTask))]
		[XmlElement("lib", typeof (NAntVisualCppTasksLibTask))]
		[XmlElement("exec", typeof (NAntCoreTasksExecTask))]
		[XmlElement("warnaserror", typeof (NAntDotNetTypesWarningAsError))]
		[XmlElement("mail", typeof (NAntCoreTasksMailTask))]
		[XmlElement("ifnot", typeof (NAntCoreTasksIfNotTask))]
		[XmlElement("sleep", typeof (NAntCoreTasksSleepTask))]
		[XmlElement("tstamp", typeof (NAntCoreTasksTStampTask))]
		[XmlElement("ilasm", typeof (NAntDotNetTasksIlasmTask))]
		[XmlElement("delete", typeof (NAntCoreTasksDeleteTask))]
		[XmlElement("sysinfo", typeof (NAntCoreTasksSysInfoTask))]
		[XmlElement("regsvcs", typeof (NAntDotNetTasksRegsvcsTask))] public object[] Items;
	...
	/// <remarks/>
	[XmlType(TypeName="NAnt.DotNet.Types.NamespaceImportCollection", Namespace="http://nant.sf.net/release/0.85-rc3/nant.xsd")]
	...
	/// <remarks/>
	[XmlType(TypeName="Tests.NAnt.Core.Util.XmlLoggerTest-TestTask", Namespace="http://nant.sf.net/release/0.85-rc3/nant.xsd")]
	...
	public class NAntCoreTasksIfTask
	{
		...
		[XmlElement("readregistry", typeof (NAntWin32TasksReadRegistryTask))]
		[XmlElement("foreach", typeof (NAntCoreTasksLoopTask))]
		[XmlElement("regsvcs", typeof (NAntDotNetTasksRegsvcsTask))]
		[XmlElement("lib", typeof (NAntVisualCppTasksLibTask))]
		[XmlElement("echo", typeof (NAntCoreTasksEchoTask))]
		[XmlElement("test", typeof (TestsNAntCoreTestTask))]
		[XmlElement("elementTest1", typeof (TestsNAntCoreElementTest1Task))]
		[XmlElement("servicecontroller", typeof (NAntMSNetTasksServiceControllerTask))]
		[XmlElement("setenv", typeof (NAntCoreTasksSetEnvTask))]
		[XmlElement("fail", typeof (NAntCoreTasksFailTask))] public object[] Items;
	...
	/// <remarks/>
	[XmlType(TypeName="NAnt.VisualCpp.Tasks.LinkTaskIgnorelibraries", Namespace="http://nant.sf.net/release/0.85-rc3/nant.xsd")]
	...
	/// <remarks/>
	[XmlType(TypeName="NAnt.DotNet.Tasks.AssemblyInfoTaskAttributes", Namespace="http://nant.sf.net/release/0.85-rc3/nant.xsd")]
	...
	/// <remarks/>
	[XmlType(TypeName="NAnt.VisualCpp.Tasks.LibTaskIgnorelibraries", Namespace="http://nant.sf.net/release/0.85-rc3/nant.xsd")]
