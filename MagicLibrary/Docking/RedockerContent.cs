...
namespace Crownwood.Magic.Docking
{
	public class RedockerContent : Redocker
	{
		...
		protected void PreProcessControlsCollection(ArrayList topList, ArrayList leftList, ArrayList rightList,
		                                            ArrayList bottomList, ArrayList fillList, int outerIndex)
		{
		...
		protected void GenerateHotZonesForRight(ArrayList rightList, Rectangle formClient, int vector, int outerIndex)
		{
			...
			if (!_dockingManager.InsideFill)
			{
				...
				Rectangle innerHotArea =
					new Rectangle(_insideRect.Right - _hotVectorBeforeControl, _insideRect.Y, _hotVectorBeforeControl,
					              _insideRect.Height);
		...
		protected void GenerateHotZonesForBottom(ArrayList bottomList, Rectangle formClient, int vector, int outerIndex)
		{
			...
			if (!_dockingManager.InsideFill)
			{
				...
				Rectangle innerHotArea =
					new Rectangle(_insideRect.X, _insideRect.Bottom - _hotVectorBeforeControl, _insideRect.Width,
					              _hotVectorBeforeControl);
