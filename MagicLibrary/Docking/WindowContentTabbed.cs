...
namespace Crownwood.Magic.Docking
{
	...
	public class WindowContentTabbed : WindowContent, IHotZoneSource, IMessageFilter
	{
		...
		public override void PropogateNameValue(PropogateName name, object value)
		{
			...
			switch (name)
			{
				case PropogateName.BackColor:
					...
					{
						BorderForControl bfc = Controls[0] as BorderForControl;
		...
		public void AddHotZones(Redocker redock, HotZoneCollection collection)
		{
			...
			Rectangle newSize = RectangleToScreen(ClientRectangle);
				...
				switch (_state)
				{
					...
					case State.DockRight:
						if (Dock != DockStyle.Fill)
						{
							...
							c.DisplaySize = new Size(ClientSize.Width, c.DisplaySize.Height);
						}
						break;
					case State.DockTop:
					case State.DockBottom:
						if (Dock != DockStyle.Fill)
						{
							...
							c.DisplaySize = new Size(c.DisplaySize.Width, ClientSize.Height);
						}
						break;
					case State.Floating:
						{
