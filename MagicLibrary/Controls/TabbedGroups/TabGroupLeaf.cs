...
namespace Crownwood.Magic.Controls
{
	public class TabGroupLeaf : TabGroupBase
	{
				...
				case NotifyCode.DisplayTabMode:
					...
					switch (_tabbedGroups.DisplayTabMode)
					{
						...
						case TabbedGroups.DisplayTabModes.ShowActiveLeaf:
							_tabControl.HideTabsMode = (_tabbedGroups.ActiveLeaf == this
							                            	? TabControl.HideTabsModes.ShowAlways
							                            	:
		...
		protected void OnPopupMenuDisplay(object sender, CancelEventArgs e)
		{
			...
			_tabControl.ContextPopupMenu.MenuCommands.AddRange(new MenuCommand[]
			                                                   	{
			                                                   		_mcClose, _mcSep1,
			                                                   		_mcProm, _mcReba,
			                                                   		_mcSep2, _mcHorz,
		...
		{
			TabGroupSequence tgs = Parent as TabGroupSequence;
