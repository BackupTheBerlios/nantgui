...
namespace Crownwood.Magic.Forms
{
	...
	public class WizardDialog : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.wizardControl.WizardPageEnter +=
				new Crownwood.Magic.Controls.WizardControl.WizardPageHandler(this.OnWizardPageEnter);
			...
			this.wizardControl.WizardPageLeave +=
				new Crownwood.Magic.Controls.WizardControl.WizardPageHandler(this.OnWizardPageLeave);
